            ...
            if(l==n->left_child && r==n->right_child) return n;
                ...
                if(l!=n->left_child){
                    if(l->parent->left_child == l){
                        Phylogeny::reroot(l->parent,l->parent->right_child,n);
                    }else{
                        Phylogeny::reroot(l->parent,l->parent->left_child,n);
                    }
                }
                else{
                    if(r->parent->left_child == r){
                        Phylogeny::reroot(r->parent,r->parent->right_child,n);
                    }else{
                        Phylogeny::reroot(r->parent,r->parent->left_child,n);
                    }
                }
                //cout << n->print() << endl;
                //exit(15);
